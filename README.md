...
코드는 Swift/AppKit/SwiftUI입니다. `WorkClock.swift`, `FocusTimer.swift`, `PetBehavior.swift`, `Localization.swift`가 각각 시간·카운트다운·행동·번역을 담당합니다. Windows용 앱은 포함하지 않습니다. 앱은 로컬 ad-hoc 서명이며 Apple 공증 배포본이 아닙니다. 다른 Mac에서는 소스로 빌드할 수 있습니다.
